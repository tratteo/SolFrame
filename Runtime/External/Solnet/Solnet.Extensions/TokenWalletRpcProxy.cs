...
namespace Solnet.Extensions
{
    ...
    internal class TokenWalletRpcProxy : ITokenWalletRpcProxy
    {
        ...
        /// <summary>
        ///   Gets the balance <b> asynchronously </b> for a certain public key. <remarks> The <c> commitment </c> parameter is optional,
        ///   the default value <see cref="Commitment.Finalized"/> is not sent. </remarks>
        /// </summary>
