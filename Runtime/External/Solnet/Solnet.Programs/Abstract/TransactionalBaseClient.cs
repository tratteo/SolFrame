...
namespace Solnet.Programs.Abstract
{
    ...
    ///   The error enum type. The enum values need to match the program error codes and be correctly mapped in BuildErrorsDictionary
    ///   abstract method.
    /// </typeparam>
    public abstract class TransactionalBaseClient<TEnum> : BaseClient where TEnum : Enum
    {
        ...
        /// <summary>
        ///   Function that builds a mapping between error codes and error values. This is used to populate the ProgramErrors dictionary
        ///   that powers the GetProgramError methods.
        /// </summary>
        ...
        ///   The callback used to sign the transaction. This delegate is called once for each <c> PublicKey </c> account that needs write
        ///   permissions according to the transaction data.
        /// </param>
