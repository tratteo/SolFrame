...
namespace Solnet.Programs.Utilities
{
    ...
    public static class Serialization
    {
        ...
        /// <summary>
        ///   Write an arbitrarily long number to the byte array at the given offset, specifying it's length in bytes. Optionally specify if
        ///   it's signed and the endianness.
        /// </summary>
        /// <param name="data"> The byte array to write data to. </param>
