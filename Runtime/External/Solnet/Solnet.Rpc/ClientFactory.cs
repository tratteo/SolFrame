...
namespace Solnet.Rpc
{
    ...
    public static class ClientFactory
    {
        ...
        public static IRpcClient GetClient(Cluster cluster, UnityEngine.ILogger logger)
        {
        ...
        /// <param name="rateLimiter">An IRateLimiter instance or null.</param>
        /// <returns>The http client.</returns>
        public static IRpcClient GetClient(Cluster cluster, UnityEngine.ILogger logger = null,
        ...
        /// <param name="logger">The logger.</param>
        /// <returns>The http client.</returns>
        public static IRpcClient GetClient(string url, UnityEngine.ILogger logger)
        {
        ...
        /// <param name="rateLimiter">An IRateLimiter instance or null.</param>
        /// <returns>The http client.</returns>
        public static IRpcClient GetClient(string url, UnityEngine.ILogger logger, IRateLimiter rateLimiter)
        {
        ...
        /// <param name="rateLimiter">An IRateLimiter instance or null.</param>
        /// <returns>The http client.</returns>
        public static IRpcClient GetClient(string url, UnityEngine.ILogger logger = null, HttpClient httpClient = null, IRateLimiter rateLimiter = null)
        {
        ...
        /// <returns>The streaming client.</returns>
        public static IStreamingRpcClient GetStreamingClient(string url, UnityEngine.ILogger logger = null, ClientWebSocket clientWebSocket = null)
        {
