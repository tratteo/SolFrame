...
namespace Solnet.Rpc.Core.Http
{
    ...
    internal abstract class JsonRpcClient
    {
        ...
        /// <summary>
        ///   Handles the result after sending a batch of requests. Outcome could be a collection of failures due to a single API issue or a
        ///   mixed bag of success and failure depending on the individual request outcomes.
        /// </summary>
