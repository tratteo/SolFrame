...
namespace Solnet.Rpc.Models
{
    ...
    public enum TransactionErrorType
    {
        ...
        AccountInUse,
        /// <summary>
        ///   A `Pubkey` appears twice in the transaction's `account_keys`. Instructions can reference `Pubkey`s more than once but the
        ///   message must contain a list with no duplicate keys
        /// </summary>
        AccountLoadedTwice,
        /// <summary>
        ...
        /// <summary>
        ///   The bank has seen this transaction before. This can occur under normal operation when a UDP packet is duplicated, as a user
        ///   error from a client not updating its `recent_blockhash`, or as a double-spend attack.
        /// </summary>
        AlreadyProcessed,
        /// <summary>
        ...
        /// <summary>
        ///   Transaction failed to sanitize accounts offsets correctly implies that account locks are not taken for this TX, and should not
        ///   be unlocked.
        /// </summary>
        SanitizeFailure,
        /// <summary>
