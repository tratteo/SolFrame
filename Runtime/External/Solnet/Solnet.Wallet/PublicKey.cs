...
namespace Solnet.Wallet
{
    ...
    public class PublicKey
    {
        ...
        /// </summary>
        /// <remarks>
        ///   Any set of 32 bytes can constitute a valid solana public key. However, not all 32-byte public keys are valid Ed25519 public
        ///   keys. <br/> Two concrete examples: <br/>
