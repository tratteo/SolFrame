namespace Chaos.NaCl.Internal.Ed25519Ref10
{
    internal static partial class FieldOperations
    {
        internal static void fe_invert(out FieldElement result, ref FieldElement z)
        {
            ...
            fe_sq(out var t0, ref z); //for (i = 1; i < 1; ++i) fe_sq(out t0, ref t0);

            /* qhasm: z8 = z2^2^2 */
            /* asm 1: fe_sq(>z8=fe#2,<z2=fe#1); for (i = 1;i < 2;++i) fe_sq(>z8=fe#2,>z8=fe#2); */
            /* asm 2: fe_sq(>z8=t1,<z2=t0); for (i = 1;i < 2;++i) fe_sq(>z8=t1,>z8=t1); */
            fe_sq(out var t1, ref t0); for (i = 1; i < 2; ++i) fe_sq(out t1, ref t1);
            ...
            fe_sq(out var t2, ref t0); //for (i = 1; i < 1; ++i) fe_sq(out t2, ref t2);
            ...
            fe_sq(out var t3, ref t2); for (i = 1; i < 20; ++i) fe_sq(out t3, ref t3);
