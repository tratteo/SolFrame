...
namespace Chaos.NaCl.Internal.Ed25519Ref10
{
    public static class MontgomeryOperations
    {
        public static void scalarmult(
            ...
            byte[] p, int poffset)
        {
            FieldOperations.fe_frombytes2(out var p0, p, poffset);
            scalarmult(out var q0, n, noffset, ref p0);
            ...
            ref FieldElement p)
        {
            ...
            x1 = p;
            FieldOperations.fe_1(out var x2);
            FieldOperations.fe_0(out var z2);
            x3 = x1;
            FieldOperations.fe_1(out var z3);
            ...
            for (pos = 254; pos >= 0; --pos)
            {
                ...
                FieldOperations.fe_sub(out var tmp0, ref x3, ref z3);

                /* qhasm: B = X2-Z2 */
                /* asm 1: fe_sub(>B=fe#6,<X2=fe#1,<Z2=fe#2); */
                /* asm 2: fe_sub(>B=tmp1,<X2=x2,<Z2=z2); */
                FieldOperations.fe_sub(out var tmp1, ref x2, ref z2);
