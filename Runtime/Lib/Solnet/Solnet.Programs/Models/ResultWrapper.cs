...
namespace Solnet.Programs.Models
{
    ...
    /// <summary>
    ///   Wraps the base subscription to have the underlying data of the subscription, which is sometimes needed to perform some logic
    ///   before returning data to the subscription caller.
    /// </summary>
