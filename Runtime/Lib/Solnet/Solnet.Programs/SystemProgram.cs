...
{
    /// <summary>
    ///   Helper class for the System Program. <remarks> Used to transfer lamports between accounts and create new accounts. </remarks>
    /// </summary>
    public static class SystemProgram
    {
        ...
        public static TransactionInstruction Transfer(string fromPublicKey, string toPublicKey, long lamports) => Transfer(Encoders.Base58.DecodeData(fromPublicKey), Encoders.Base58.DecodeData(toPublicKey), lamports);
            ...
            long space, string programId)
        {
            return CreateAccount(
                Encoders.Base58.DecodeData(fromPublicKey),
                Encoders.Base58.DecodeData(newAccountPublicKey),
                lamports,
                space,
                Encoders.Base58.DecodeData(programId)
                );
        }
