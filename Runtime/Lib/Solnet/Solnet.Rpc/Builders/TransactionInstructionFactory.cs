...
{
    /// <summary>
    ///   Methods to create instances of the TransactionInstruction for languages that do not support set-only setters
    /// </summary>
    public static class TransactionInstructionFactory
    {
        /// <summary>
        ///   Helper method to make TransactionInstruction objects available to outside Program implementations in languages that do not
        ///   currently support immutable set-only setters like VB.Net
        /// </summary>
