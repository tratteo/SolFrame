...
namespace Solnet.Rpc.Models
{
    ...
    public class AccountInfoBase
    {
        ...
        /// <summary>
        ///   The account owner. <remarks> This value could be another regular address or a program. </remarks>
        /// </summary>
    ...
    {
        /// <summary>
        ///   The actual account data. <remarks> This field should contain two values: first value is the data, the second one is the
        ///   encoding - should always read base64. </remarks>
        /// </summary>
