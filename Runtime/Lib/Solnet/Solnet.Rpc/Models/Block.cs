...
namespace Solnet.Rpc.Models
{
    ...
    public class BlockInfo
    {
        ...
        /// <summary>
        ///   A base-58 encoded public key representing the block hash of this block's parent. <remarks> If the parent block is no longer
        ///   available due to ledger cleanup, this field will return '11111111111111111111111111111111' </remarks>
        /// </summary>
    ...
    public class TransactionMeta
    {
        ...
        /// <summary>
        ///   List of token balances from before the transaction was processed or omitted if token balance recording was not yet enabled
        ///   during this transaction.
        /// </summary>
        public TokenBalanceInfo[] PreTokenBalances { get; set; }

        /// <summary>
        ///   List of token balances from after the transaction was processed or omitted if token balance recording was not yet enabled
        ///   during this transaction.
        /// </summary>
    ...
    {
        /// <summary>
        ///   A list of values representing the amount of cluster stake in lamports that has voted onn the block at each depth from 0 to
        ///   (max lockout history + 1).
        /// </summary>
