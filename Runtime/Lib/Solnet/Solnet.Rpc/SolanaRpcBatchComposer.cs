...
namespace Solnet.Rpc
{
    ...
    public class SolanaRpcBatchComposer
    {
        ...
        /// <summary>
        ///   Execute a batch request and process the response into the expected native types. Batch failure execption will invoke callbacks
        ///   with an exception.
        /// </summary>
        ...
        /// <summary>
        ///   Execute a batch request and process the response into the expected native types. Batch failure execption will throw an
        ///   Exception and bypass callbacks.
        /// </summary>
