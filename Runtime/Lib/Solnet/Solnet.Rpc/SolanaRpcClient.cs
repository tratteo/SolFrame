...
namespace Solnet.Rpc
{
    ...
    {
        //private static Base58Encoder Encoder = new Base58Encoder();
        ...
        private JsonRpcRequest BuildRequest<T>(string method, IList<object> parameters)
            => new JsonRpcRequest(idGenerator.GetNextId(), method, parameters);
        ...
        public async Task<RequestResult<ResponseValue<ulong>>> GetBalanceAsync(string pubKey) => await SendRequestAsync<ResponseValue<ulong>>("getBalance", new List<object> { pubKey });
        ...
        //public async Task<RequestResult<ResponseValue<SignatureStatus[]>>> GetSignatureStatuses(string pubKey) => await SendRequestAsync<ResponseValue<SignatureStatus[]>>("getSignatureStatuses", new List<object> { new string[] { pubKey } });
        ...
        public async Task<RequestResult<BlockCommitment>> GetBlockCommitmentAsync(ulong slot) => await SendRequestAsync<BlockCommitment>("getBlockCommitment", new List<object> { slot });

        /// <inheritdoc cref="GetBlockCommitmentAsync"/>
        public RequestResult<BlockCommitment> GetBlockCommitment(ulong slot) => GetBlockCommitmentAsync(slot).Result;
        ...
        public async Task<RequestResult<ulong>> GetBlockTimeAsync(ulong slot) => await SendRequestAsync<ulong>("getBlockTime", new List<object> { slot });

        /// <inheritdoc cref="GetBlockTimeAsync"/>
        public RequestResult<ulong> GetBlockTime(ulong slot) => GetBlockTimeAsync(slot).Result;
        ...
        public async Task<RequestResult<ClusterNode[]>> GetClusterNodesAsync() => await SendRequestAsync<ClusterNode[]>("getClusterNodes");

        /// <inheritdoc cref="GetClusterNodesAsync"/>
        public RequestResult<ClusterNode[]> GetClusterNodes() => GetClusterNodesAsync().Result;

        /// <summary>
        ///   Gets identity and transaction information about a confirmed block, identified by slot.
        /// </summary>
        /// <returns> A task which may return a request result and information about the nodes participating in the cluster. </returns>
        public async Task<RequestResult<ClusterNode[]>> GetConfirmedBlockAsync(ulong slot) => await SendRequestAsync<ClusterNode[]>("getConfirmedBlock", new List<object> { slot });

        /// <inheritdoc cref="GetConfirmedBlockAsync"/>
        public RequestResult<ClusterNode[]> GetConfirmedBlock(ulong slot) => GetConfirmedBlockAsync(slot).Result;

        /// <summary>
        ///   Gets a recent block hash.
        /// </summary>
        /// <returns> A task which may return a request result and recent block hash. </returns>
        public async Task<RequestResult<ResponseValue<BlockHash>>> GetRecentBlockHashAsync() => await SendRequestAsync<ResponseValue<BlockHash>>("getRecentBlockhash");

        /// <inheritdoc cref="GetBlockTimeAsync"/>
        public RequestResult<ResponseValue<BlockHash>> GetRecentBlockHash() => GetRecentBlockHashAsync().Result;
        ...
        public async Task<RequestResult<ulong>> GetMinimumBalanceForRentExemptionAsync(long accountDataSize) => await SendRequestAsync<ulong>("getMinimumBalanceForRentExemption", new List<object> { accountDataSize });

        /// <inheritdoc cref="GetMinimumBalanceForRentExemptionAsync"/>
        public RequestResult<ulong> GetMinimumBalanceForRentExemption(long accountDataSize) => GetMinimumBalanceForRentExemptionAsync(accountDataSize).Result;
        ...
        public async Task<RequestResult<string>> GetGenesisHashAsync() => await SendRequestAsync<string>("getGenesisHash");
        ...
        public async Task<RequestResult<ResponseValue<Supply>>> GetSupplyAsync() => await SendRequestAsync<ResponseValue<Supply>>("getSupply");

        /// <inheritdoc cref="GetSupplyAsync"/>
        public RequestResult<ResponseValue<Supply>> GetSupply() => GetSupplyAsync().Result;
        ...
        public async Task<RequestResult<ResponseValue<TokenBalance>>> GetTokenAccountBalanceAsync(string splTokenAccountPublicKey) => await SendRequestAsync<ResponseValue<TokenBalance>>("getTokenAccountBalance", new List<object> { splTokenAccountPublicKey });

        /// <inheritdoc cref="GetTokenAccountBalanceAsync"/>
        public RequestResult<ResponseValue<TokenBalance>> GetTokenAccountBalance(string splTokenAccountPublicKey) => GetTokenAccountBalanceAsync(splTokenAccountPublicKey).Result;
        ...
        /// <returns> A task which may return a request result and information about largest accounts. </returns>
        public async Task<RequestResult<ResponseValue<TokenAccount[]>>> GetTokenAccountsByDelegateAsync(string ownerPubKey, string tokenMintPubKey = "", string tokenProgramId = "")
        {
        ...
        public RequestResult<ResponseValue<TokenAccount[]>> GetTokenAccountsByDelegate(string ownerPubKey, string tokenMintPubKey = "", string tokenProgramId = "") => GetTokenAccountsByDelegateAsync(ownerPubKey, tokenMintPubKey, tokenProgramId).Result;
        ...
        /// <param name="tokenProgramId"> Public key of the Token program ID that owns the accounts, as base-58 encoded string. </param>
        /// <returns> A task which may return a request result and information about largest accounts. </returns>
        public async Task<RequestResult<ResponseValue<TokenAccount[]>>> GetTokenAccountsByOwnerAsync(string ownerPubKey, string tokenMintPubKey = "", string tokenProgramId = "")
        {
            var options = new Dictionary<string, object>();
            if (!string.IsNullOrWhiteSpace(tokenMintPubKey)) options.Add("mint", tokenMintPubKey);
            if (!string.IsNullOrWhiteSpace(tokenProgramId)) options.Add("programId", tokenProgramId);
        ...
        public RequestResult<ResponseValue<TokenAccount[]>> GetTokenAccountsByOwner(string ownerPubKey, string tokenMintPubKey = "", string tokenProgramId = "") => GetTokenAccountsByOwnerAsync(ownerPubKey, tokenMintPubKey, tokenProgramId).Result;
        ...
        /// <returns> A task which may return a request result and information about largest accounts. </returns>
        public async Task<RequestResult<ResponseValue<LargeAccount[]>>> GetTokenLargestAccountsAsync(string tokenMintPubKey) => await SendRequestAsync<ResponseValue<LargeAccount[]>>("getTokenLargestAccounts", new List<object> { tokenMintPubKey });

        /// <inheritdoc cref="GetTokenLargestAccountsAsync"/>
        public RequestResult<ResponseValue<LargeAccount[]>> GetTokenLargestAccounts(string tokenMintPubKey) => GetTokenLargestAccountsAsync(tokenMintPubKey).Result;
        ...
        /// <param name="tokenMintPubKey"> Public key of Token Mint to query, as base-58 encoded string. </param>
        /// <returns> A task which may return a request result and information about the supply. </returns>
        public async Task<RequestResult<ResponseValue<TokenBalance>>> GetTokenSupplyAsync(string tokenMintPubKey) => await SendRequestAsync<ResponseValue<TokenBalance>>("getTokenSupply", new List<object> { tokenMintPubKey });

        /// <inheritdoc cref="GetTokenSupplyAsync"/>
        public RequestResult<ResponseValue<TokenBalance>> GetTokenSupply(string tokenMintPubKey) => GetTokenSupplyAsync(tokenMintPubKey).Result;

        #endregion Token Supply and Balances
        ...
        public async Task<RequestResult<ulong>> GetTransactionCountAsync() => await SendRequestAsync<ulong>("getTransactionCount");

        /// <inheritdoc cref="GetTransactionCountAsync"/>
        public RequestResult<ulong> GetTransactionCount() => GetTransactionCountAsync().Result;

        /// <summary>
        ///   Gets the lowest slot that the node has information about in its ledger. <remarks> This value may decrease over time if a node
        ///   is configured to purging data. </remarks>
        /// </summary>
        /// <returns> A task which may return a request result and the minimum slot available. </returns>
        public async Task<RequestResult<ulong>> GetMinimumLedgerSlotAsync() => await SendRequestAsync<ulong>("minimumLedgerSlot");
        ...
        /// <summary>
        ///   Requests an airdrop to the passed <c> pubKey </c> of the passed <c> lamports </c> amount. <remarks> The <c> commitment </c>
        ///   parameter is optional, the default <see cref="Commitment.Finalized"/> is used. </remarks>
        /// </summary>
        ...
        public async Task<RequestResult<string>> RequestAirdropAsync(string pubKey, ulong lamports, Commitment commitment = Commitment.Finalized) => await SendRequestAsync<string>("requestAirdrop", new List<object> { pubKey, lamports });//, commitment

        /// <inheritdoc cref="RequestAirdropAsync"/>
        public RequestResult<string> RequestAirdrop(string pubKey, ulong lamports, Commitment commitment = Commitment.Finalized) => RequestAirdropAsync(pubKey, lamports, commitment).Result;
        ...
        /// <param name="encoding"> The encoding of the transaction. </param>
        /// <returns> A task which may return a request result and the transaction status. </returns>
